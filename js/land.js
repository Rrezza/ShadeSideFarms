// ============================================================
// land.js — Land section sub-pages
//   - Crop Tracking      (default)
...
//   - Water Tests
//
// Plot definition / management lives in Setup → Plots (setup_plots.js)
//
...
async function loadLandPage() {
  // Loading indicator — use any container that's present
  var loadingEl = document.getElementById('land-app-table');
...
function populateLandDropdowns() {
  // Plot dropdowns (forms + filters) — plot definitions live in Setup → Plots
